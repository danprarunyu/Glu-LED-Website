document.addEventListener("DOMContentLoaded", function () {
    ...
    /* ══════════════════════════════════════
       ...
       *** แก้ไขข้อมูลผลงานจริงตรงนี้ ***
       outdoor | indoor | retail | event
    ══════════════════════════════════════ */
    const projects = [
        { name: ' ',          cat: 'indoor', size: '200 * 100', client: '### ลูกค้า', year: '2026', icon: '🏙️', image: './slidept/1.png' },
        { name: ' ',               cat: 'indoor',  size: '400 * 200', client: '### ลูกค้า', year: '2026', icon: '🏬',  image: './slidept/2.png' },
        { name: ' ',      cat: 'indoor', size: '600 * 200', client: '### ลูกค้า', year: '2026', icon: '🌴',  image: './slidept/3.png' },
        { name: '', cat: 'indoor', size: '800 * 200', client: '### ลูกค้า', year: '2026', icon: '🛒', image: './slidept/4.png' },
        { name: '',         cat: 'indoor',   size: '400 * 200', client: '### ลูกค้า', year: '2026', icon: '🎤',  image: './slidept/5.png' },
        { name: '',   cat: 'indoor',  size: '500 * 200', client: '### ลูกค้า', year: '2026', icon: '🏨',  image: './slidept/6.png' },
    ];
...
(function () {
    ...
    var PRODUCTS = [
        {
            id: 1,
            name: 'Outdoor Q2 LED Module',
            type: 'outdoor',
            image: 'product/1.png',
            pitch: 'P6',
            price: 'X bath/module',
            priceTag: 'X bath/module',
            short: 'จอ LED กลางแจ้งทนแดดทนฝน ที่สุดแห่งความคมชัด ภาพเนียนตา ลื่นไหลระดับอัลตร้า',
        ...
        {
            id: 2,
            name: 'Outdoor Q4 Pro LED Module',
            type: 'indoor',
            image: 'product/2.png',
            pitch: 'P4',
            price: 'x bath/module',
            priceTag: 'x bath/module',
            short: 'ความละเอียดสูง ที่สุดแห่งความคุ้มค่า ตอบโจทย์จอกลางแจ้ง!ความละเอียดสูง สู้แดด ทนฝน!!',
        ...
        {
            id: 3,
            name: 'Outdoor Q4-E LED Module',
            type: 'outdoor',
            image: 'product/3.png',
            pitch: 'P2.5',
            price: 'x bath/module',
            priceTag: 'x bath/module',
            short: 'จอ LED กลางแจ้ง ความละเอียดสูง ที่สุดแห่งความคุ้มค่า ตอบโจทย์จอกลางแจ้ง ความละเอียดสูง สู้แดด ทนฝน!!',
        ...
        },
        {
            ...
            price: 'x bath/module',
            priceTag: 'x bath/module',
            short: 'ทางเลือกที่ใช่ของความคมชัดระดับ HD งบสบายกระเป๋า คุณภาพสากล!!!',
        ...
        {
            id: 5,
            name: 'Indoor Q1.8 Pro',
            type: 'indoor',
            image: 'product/5.png',
            pitch: 'P3.9',
            price: 'x bath/module',
            priceTag: 'x bath/module',
            short: 'ก้าวข้ามทุกขีดจำกัด ยืนหนึ่งเรื่องความละเอียดพิกเซลขนาดเล็ก เพื่อภาพที่สมบูรณ์แบบ!!',
        ...
        },
        {
            ...
            price: 'x bath/module',
            priceTag: 'x bath/module',
            short: 'ที่สุดแห่งความละเอียดและค้มทุน โซลูชั่นพรีเมียมในร่มที่คุ้มค่าที่สุด',
        ...
        {
            id: 8,
            name: 'Indoor q2.5H R Flexible Module',
            type: 'creative',
            image: 'product/8.png',
            pitch: 'P4',
            price: 'x bath/module',
            priceTag: 'x bath/module',
            short: 'จอโค้ง 3D Illusion ปฏิวัติวงการดีไซน์ บิดงอได้ตามจินตนาการ ทลายทุกกรอบจอแบนแบบเดิมๆ',
            desc: 'นวัตกรรมจอโค้งที่รองรับมุมโค้งสูงสุด 30° เหมาะกับสถาปัตยกรรมพิเศษ มุมตึก หรืองาน Brand Activation ที่ต้องการความ WOW',
            specs: [
                { label: 'Pixel Pitch', value: 'P4' },
                { label: 'ความสว่าง', value: '5,000 nits' },
        ...
        {
            id: 9,
            name: 'Indoor Q2.5-E LED Module',
            type: 'indoor',
            image: 'product/9.png',
            pitch: 'P4',
            price: 'x bath/module',
            priceTag: 'x bath/module',
            short: 'โมดูลในร่มยอดนิยมอันดับ 1 ทัศนียภาพที่เหนือกว่าในราคาที่ใครก็ปฏิเสธไม่ได้',
            desc: 'นวัตกรรมจอโค้งที่รองรับมุมโค้งสูงสุด 30° เหมาะกับสถาปัตยกรรมพิเศษ มุมตึก หรืองาน Brand Activation ที่ต้องการความ WOW',
            specs: [
                { label: 'Pixel Pitch', value: 'P4' },
                { label: 'ความสว่าง', value: '5,000 nits' },
        ...
        {
            id: 10,
            name: 'Q2H-R Flexible Module',
            type: 'creative',
            image: 'product/11.png',
            pitch: 'P4',
            price: 'x bath/module',
            priceTag: 'x bath/module',
            short: '“ยืดหยุ่นขั้นสุด บางเบาเร้าใจ ดีไซน์หรูหราด้วย  Deep V Silicon Shell”',
            desc: 'นวัตกรรมจอโค้งที่รองรับมุมโค้งสูงสุด 30° เหมาะกับสถาปัตยกรรมพิเศษ มุมตึก หรืองาน Brand Activation ที่ต้องการความ WOW',
            specs: [
                { label: 'Pixel Pitch', value: 'P4' },
                { label: 'ความสว่าง', value: '5,000 nits' },
